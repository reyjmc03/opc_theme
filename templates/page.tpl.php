    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <p align="justify">
            OWASP is a nonprofit community organization with 200 chapters in over 100 countries around the world. 
            Our mission is to make software security visible, so that individuals and organizations worldwide can 
            make informed decisions about true software security risks. Our wiki has a wealth of security knowledge 
            and we are well known for many of our influential security projects. The OWASP AppSec conferences represent 
            our largest outreach efforts to advance our mission of spreading security knowledge. These events help fund 
            the non-profit organization and provide a great learning experience for everyone involved. 
          </p>
        </div><!-- /.col-sm-6 -->
        ...
        <div class="col-sm-6">
            ...
            <ul class="list-arrow-right">
              <li>To provide technical talks from industry leaders.</li>
              <li>Hands-on training sessions to learn in top security areas.</li>
              <li>Provide an interactive activities including war games, capture the flag, security tool training and many more</li>
...
<div class="clearfloat"></div>
    ...
    <section id="sponsors" class="section partner">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="section-sub-title">Diamond</h3>
          </div>
          <hr class="hrl">
          <div class="row">
            <div class="col-sm-12">
        ...
        <?php # platinum sponsor ?>
        <div class="row">
          <div class="col-sm-12">
            <h3 class="section-sub-title">Platinum</h3>
          </div>
          <hr class="hrl">
          <div class="row">
            <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="section-sub-title">Gold</h3>
          </div>
          <hr class="hrl">
          <div class="row">
            <div class="col-sm-4">
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="section-sub-title">Silver</h3>
          </div>
          <hr class="hrl">
          <div class="row">
            <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="section-sub-title">Others</h3>
          </div class="hrl">
          <hr>
          <div class="row">
            <div class="col-sm-3">
